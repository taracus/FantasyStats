...
//    using QuickType;
//
//    var fantasyLeague = FantasyLeague.FromJson(jsonString);
...
namespace PLFantasy
{
    ...
    public partial class FantasyLeague
    {
    ...
    public partial class FantasyLeague
    {
        public static FantasyLeague FromJson(string json) => JsonConvert.DeserializeObject<FantasyLeague>(json, Converter.Settings);
    }
    ...
    internal class MovementConverter : JsonConverter
    {
        ...
        public static readonly MovementConverter Singleton = new MovementConverter();
    }
}
